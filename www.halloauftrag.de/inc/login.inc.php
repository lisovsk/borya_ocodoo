...
if($lg!="ok") {
?>
<form action="index.php" method="post" class="form-inline" accept-charset="UTF-8"><input type=hidden name=d value="<?php echo $d; ?>"><input type=hidden name=u value="<?php echo $u; ?>"><input type=hidden name=s value="<?php echo $s; ?>"><input type=hidden name=projekt value="<?php echo $projekt; ?>"><input type=hidden name=betrag value="<?php echo $betrag; ?>">
