...
<li><a href="#auftraege" data-toggle="tab"><img src="images/ico_auftrag.png" width=16 height=16 align=absmiddle border=0> Aufträge</a></li>
...
<div class="tab-pane fade" id="auftraege" style="margin-bottom:30px;">';


$getuk = mysqli_query($db,"SELECT * FROM ".$dbx."_auftraege WHERE user='".$profil[id]."' ORDER BY datum DESC");
