...
if($anfrage[id]=="" || $unterkunft[id]=="" || $mieter[id]=="" || time()>$anfrage[datum]+$bestime) echo '<div class="alert alert-danger"><b>Ups!</b> Die Buchungsanfrage ist nicht mehr verfügbar.</div><div>Das kann mehrere Ursachen haben:<ul>
...
mail($mieter[email],"Buchungsanfrage bestätigt: ".$unterkunft[titel],$mailtext,"From: ".$coredata[titel]." <".$coredata[email].">");
...
$mailtext  = str_replace($ph1,$ph2,$mailtext);
mail($usrd[email],"Buchungsanfrage bestätigt: ".$unterkunft[titel],$mailtext,"From: ".$coredata[titel]." <".$coredata[email].">");

echo '<div class="alert alert-success"><b>Vielen Dank!</b> Die Buchung ist nun bestätigt.</div><div>Sie erhalten in Kürze eine E-Mail mit den weiteren Details und den Kontaktdaten des Mieters.</div>';
...
<tr><td><b>Anzahl Nächte:</b></td><td>'.$mietdauer.'</td></tr>
