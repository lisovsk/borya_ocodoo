...
<li><a href="#unterkuenfte" data-toggle="tab"><img src="images/ico_unterkunft.png" width=16 height=16 align=absmiddle border=0> Unterkünfte</a></li>
...
<div class="tab-pane fade" id="unterkuenfte" style="margin-bottom:30px;">';


$getuk = mysql_query("SELECT * FROM ".$dbx."_unterkunft WHERE user='".$profil[id]."'");
$ukcounter=mysql_num_rows($getuk);

if($ukcounter==0) echo '<div class="alert alert-danger">Noch keine Unterkünfte inseriert.</div>';
else {

echo '<table class="table table-hover"><thead><tr><td colspan=3><div class="row"><div class="col-lg-6 col-sm-6" style="font-weight:bold;">'; if($ukcounter==1) echo 'Eine Unterkunft'; else echo $ukcounter.' Unterkünfte'; echo '</div></td></tr></thead>';

while($unterkunft=mysql_fetch_array($getuk)) {
echo '<tr><td><div class="row"><div class="col-lg-2 col-sm-3 col-6" style="margin-right:-15px;"><div style="max-width:260px;max-height:100px;overflow:hidden;" class="bigroundcorners"><a href="'.genURL('unterkunft',$unterkunft[id],urlseotext($unterkunft[titel])).'">';
...
echo ' in <a href="'.genUrl('suchen',urlencode($unterkunft[ort])).'">'.$unterkunft[ort].'</a></div>
<div style="padding-bottom:5px;color:#888;">
...
<span style="font-weight:bold;font-size:22px;letter-spacing:-1px;">'.$unterkunft[preis_nacht].',00 '; if($coredata['waehrung']=="EUR") echo '&euro;'; else echo $coredata['waehrung']; echo '</span><br>pro Nacht
