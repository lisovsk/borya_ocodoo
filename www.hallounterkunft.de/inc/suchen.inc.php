...
<input type="hidden" id="schlafzimmermin" name="schlafzimmermin" value='.$schlafzimmermin.'>
<input type="hidden" id="schlafzimmermax" name="schlafzimmermax" value='.$schlafzimmermax.'>
...
<input type="hidden" id="badezimmermin" name="badezimmermin" value='.$badezimmermin.'>
<input type="hidden" id="badezimmermax" name="badezimmermax" value='.$badezimmermax.'>
...
<input type="hidden" id="groessemin" name="groessemin" value='.$groessemin.'>
<input type="hidden" id="groessemax" name="groessemax" value='.$groessemax.'>
