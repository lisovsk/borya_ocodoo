...
elseif($buchung[buchung]=="miete") echo '<a href="'.genURL('unterkunft',$buchung[unterkunft]).'">Unterkunft</a> gemietet';
elseif($buchung[buchung]=="vermietung") echo '<a href="'.genURL('unterkunft',$buchung[unterkunft]).'">Unterkunft</a> vermietet';
elseif($buchung[buchung]=="rueckerstattung") echo 'Rückerstattung: Buchung der <a href="'.genURL('unterkunft',$buchung[unterkunft]).'">Unterkunft</a> abgebrochen';
