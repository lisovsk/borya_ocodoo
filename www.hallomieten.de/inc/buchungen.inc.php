...
echo '<legend>Meine Gegenstände</legend>';
$DO_TITEL="Meine Gegenstände";
...
else echo '<div class="alert alert-danger"><b>Ups!</b> Abbrechen der Mietanfrage nicht möglich.</div>';
...
<li class="active"><a href="#mieter" data-toggle="tab">Gemietete Gegenstände</a></li>
<li><a href="#vermieter" data-toggle="tab">Vermietete Gegenstände</a></li>
</ul>
...
if(mysql_num_rows($getBuchungen)==0) echo '<br><div class="alert alert-danger">Sie haben aktuell keine Gegenstände gemietet.</div>';
else {
...
if($buchung[art]=="ma") echo '<img src=images/ico_wait.png width=16 height=16 align=absmiddle> <font color=#e53b29><i>noch nicht bestätigt</i></font><br><img src=images/ico_delete.png width=16 height=16 align=absmiddle> <a href="index.php?d=buchungen&abbrechen='.$buchung[id].'">Mietanfrage abbrechen</a>';
...
if(mysql_num_rows($getBuchungen)==0) echo '<br><div class="alert alert-danger">Sie haben aktuell keine Gegenstände vermietet.</div>';
else {
while($buchung=mysql_fetch_array($getBuchungen)) {
