...
<li><a href="#gegenstaende" data-toggle="tab"><img src="images/ico_gegenstand.png" width=16 height=16 align=absmiddle border=0> Gegenstände</a></li>
...
<tr><td>Wohnort</td><td><img src=images/flaggen/'.$profil[land].'.gif width=18 height=12 align=absmiddle> <a href="http://maps.google.de/maps?f=q&source=s_q&hl=de&q='.$unterkunft[plz].'+'.$profil[ort].'" target=_blank>'.$profil[ort].'</a></td></tr>
<tr><td>Geschlecht</td><td>'; if($usrd[geschlecht]=="m") echo 'männlich'; else echo 'weiblich'; echo '</td></tr>
';
...
<div class="tab-pane fade" id="gegenstaende" style="margin-bottom:30px;">';


$getuk = mysql_query("SELECT * FROM ".$dbx."_gegenstand WHERE user='".$profil[id]."'");
$ukcounter=mysql_num_rows($getuk);

if($ukcounter==0) echo '<div class="alert alert-danger">Noch keine Gegenstände inseriert.</div>';
else {

echo '<table class="table table-hover"><thead><tr><td colspan=3><div class="row"><div class="col-lg-6 col-sm-6" style="font-weight:bold;">'; if($ukcounter==1) echo 'Ein Gegenstand'; else echo $ukcounter.' Gegenstände'; echo '</div></td></tr></thead>';

while($gegenstand=mysql_fetch_array($getuk)) {
echo '<tr><td><div class="row"><div class="col-lg-2 col-sm-3 col-6" style="margin-right:-15px;"><div style="max-width:260px;max-height:100px;overflow:hidden;" class="bigroundcorners"><a href="'.genURL('gegenstand',$gegenstand[id],urlseotext($gegenstand[titel])).'">';
...
<div style="padding-bottom:5px;"><a href="'.genURL('gegenstand',$gegenstand[id],urlseotext($gegenstand[titel])).'" style="text-decoration:none;color:#333;">'.textKuerzen(strip_tags($gegenstand[cont]),50).'</a></div>
<div style="padding-bottom:5px;color:#888;">
...
<span style="font-weight:bold;font-size:22px;letter-spacing:-1px;">'.$gegenstand[preis_tag].',00 '; if($coredata['waehrung']=="EUR") echo '&euro;'; else echo $coredata['waehrung']; echo '</span><br>pro Tag
