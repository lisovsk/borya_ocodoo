...
<img src="images/ico_delete.png" width=16 height=16 align=absmiddle> <a href="index.php?d=edit&del='.$fahrzeug[id].'">Löschen</a>&nbsp;
<img width=16 height=16 align=absmiddle src=images/ico_uhr.png> <a href="index.php?d=edit&nvfb='.$fahrzeug[id].'">Nichtverfügbarkeit eintragen</a>
</div>';
...
<div class=row style="margin:0px !important;padding-bottom:3px;padding-top:3px;border-bottom:1px dotted #bbb;">'.ucfirst($fahrzeug[tueren]).' Türen</div>
<div class=row style="margin:0px !important;padding-bottom:3px;padding-top:3px;border-bottom:1px dotted #bbb;">'.ucfirst($fahrzeug[sitze]).' Sitzplätze</div>
...
Der Kalender ist nicht verbindlich und nur eine Annäherung an die Verfügbarkeit. Buchungsanfragen können vom Vermieter auch trotz Verfügbarkeit abgelehnt werden.<br><br>
<img src=images/stat_ja.png width=11 height=11 align=absmiddle> Fahrzeug verfügbar<br>
...
<img src=images/stat_neutral.png width=11 height=11 align=absmiddle> Fahrzeug nicht verfügbar
</div>';
...
<div class="col-12" style="padding:0px !important;padding-top:10px !important;margin-top:10px;border-top:1px dotted #bbb;"><img src=images/ico_sprit.png width=16 height=16 align=absmiddle> zzgl. Sprit (zurück mit selbem Tankstand)<br>

<img src=images/ico_strasse.png width=16 height=16 align=absmiddle> ';

$betrag_zusatzkm = $fahrzeug[zusatzkm] / 100;

if($fahrzeug[inklkm]==0) echo 'inkl. unbeschränkte Kilometer';
else {
echo 'inkl. '.$fahrzeug[inklkm].' Kilometer pro Tag<br><img src=images/ico_next.png width=16 height=16 align=absmiddle> '.number_format($betrag_zusatzkm,2,',','').' '; if($coredata['waehrung']=="EUR") echo '&euro;'; else echo $coredata['waehrung']; echo ' pro zusätzlichem Kilometer';
}
