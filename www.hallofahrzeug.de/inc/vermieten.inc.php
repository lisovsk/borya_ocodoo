...
echo '<div>Inserieren Sie Ihr Fahrzeug bei '.$coredata[titel].' und verdienen Sie einfach und regelmäßig Geld dazu. Das Inserieren ist komplett kostenlos, erst bei erfolgreichen Buchungen wird eine Gebühr von '.$coredata['gebuehr'].'% vom Mietspreis abgezogen.</div><br><br>';
...
<span class="help-block">Ein paar Details zum Fahrzeug, Ausstattung und über Sie als Vermieter:</span>
...
<option value=200001>Über 200.001</option>
</select>
