...
elseif($buchung[buchung]=="miete") echo '<a href="'.genURL('fahrzeug',$buchung[fahrzeug]).'">Fahrzeug</a> gemietet';
elseif($buchung[buchung]=="vermietung") echo '<a href="'.genURL('fahrzeug',$buchung[fahrzeug]).'">Fahrzeug</a> vermietet';
elseif($buchung[buchung]=="rueckerstattung") echo 'Rückerstattung: Buchung der <a href="'.genURL('fahrzeug',$buchung[fahrzeug]).'">Fahrzeug</a> abgebrochen';
